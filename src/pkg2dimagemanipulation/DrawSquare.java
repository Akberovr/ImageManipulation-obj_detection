 ...
 */
package pkg2dimagemanipulation;
 ...
 * @author asus
 */
public class DrawSquare implements GLEventListener {
    ...
    public int[][] make2DArray(int cols, int rows) {
...
//        List<Point> temp_list = new ArrayList<>();
    ...
    public static void main(String[] args) {
        DrawSquare o1 = new DrawSquare();
        System.out.println(o1.countIslands(o1.make2DArray(COL, ROW)));
        ...
        final JFrame frame = new JFrame("Basdalama Damarimi");
